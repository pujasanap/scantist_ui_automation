...
public class dbConnect {
	...
	public String url = "jdbc:postgresql://scantist-staging.cqy3hiulpjht.ap-southeast-1.rds.amazonaws.com:5432/scantist";
	public String user = "scantist";
	public String password = "4jKU9890wsda";
	...
	public Connection deleteUploadFile() {
		...
		try {
			...
			String sql = "Delete from scantist_codeupload where filename='jfinal-master.zip' AND project_id=2324;";
